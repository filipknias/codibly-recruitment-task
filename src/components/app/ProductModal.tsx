...
export default function ProductModal({ product, onClose }: TProps) {
    ...
    return (
        <div className="h-full w-full bg-black bg-opacity-80 fixed inset-0 z-50">
            <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full" ref={modalRef}>
                <div className="bg-white rounded-lg p-5 max-w-2xl mx-auto">
